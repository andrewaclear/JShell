...
public class Manual extends Command {
  ...
  public Manual() {
    ...
    descriptions.put("man", manDesc);
    descriptions.put("cd", cdDesc);
    descriptions.put("cat", catDesc);
    descriptions.put("echo", echoDesc);
    descriptions.put("exit", exitDesc);
    descriptions.put("history", historyDesc);
    descriptions.put("ls", lsDesc);
    descriptions.put("mkdir", mkdirDesc);
    descriptions.put("popd", popdDesc);
    descriptions.put("pwd", pwdDesc);
