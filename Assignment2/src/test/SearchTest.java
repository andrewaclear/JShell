...
public class SearchTest {
   ...
   * 
   * Test method for {@link commands.Search#run(java.lang.String[], driver.JShell)}.
   */
  @Test
  public final void testRun0() {
    ...
    assertEquals("search: \"l\": No such file or directory", search.getErrors());
  }
  ...
  public final void testRun1() {
    ...
    search.run(tokens, shell);
    assertEquals(".: does not contain directory: \"wowDir\"", search.getOutput());
    assertEquals(null, search.getErrors());
    ...
    search.run(tokens2, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: \"z\": No such file or directory", search.getErrors());
  }
  ...
  public final void testRun2() {
    ...
    assertEquals(null, search.getOutput());
    assertEquals("search: \"/a/l\": No such file or directory", search.getErrors());
  ...
  public final void testRun3() {
    ...
    search.run(tokens4, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: \"x\": No such file or directory", search.getErrors());
  ...
  public final void testRun4() {
    String[] tokens = {"search", "a", "b", "b/d", "-type", "f", "-name", "\"c\""};
    search.run(tokens, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: \"a\": No such file or directory", search.getErrors());
  }
  ...
  public final void testRun5() {
    ...
    search.run(tokens, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: \"w\": No such file or directory", search.getErrors());
  }
  ...
  public final void testRun6() {
    ...
    String[] tokens = {"search", "a", "b", "b/d", "-type", "f", "-name", "\"c\""};
    search.run(tokens, shell);
    assertEquals("a/e/f/c\nb/c\nb/d: does not contain file: \"c\"", search.getOutput());
    assertEquals(null, search.getErrors());

    String[] tokens2 = {"search", "a", "a", "a/e", "b/d", "b/a", "z", "a", "-type", "f", "-name", "\"c\""};
    search = new Search();
    search.run(tokens2, shell);
    assertEquals("a/e/f/c\na/e/f/c\na/e/f/c\nb/d: does not contain file: \"c\"\nb/a: does not contain file: \"c\"", search.getOutput());
    assertEquals("search: \"z\": No such file or directory", search.getErrors());

    String[] tokens3 = {"search", "a", "b/a", "-type", "f", "-name", "\"s\""};
    search = new Search();
    search.run(tokens3, shell);
    assertEquals("a: does not contain file: \"s\"\nb/a: does not contain file: \"s\"", search.getOutput());
    assertEquals(null, search.getErrors());
  ...
  public final void testRun7() {
    fSystemSetup1();
    String[] tokens = {"search", "a", "b", "b/d", "-type", "d", "-name", "\"a\""};
    search.run(tokens, shell);
    assertEquals("a: does not contain directory: \"a\"\nb/a\nb/d: does not contain directory: \"a\"", search.getOutput());
    assertEquals(null, search.getErrors());

    String[] tokens2 = {"search", "a", "a", "a/e", "b/d", "b/a", "x", "a", "-type", "d", "-name", "\"a\""};
    search = new Search();
    search.run(tokens2, shell);
    assertEquals("a: does not contain directory: \"a\"\na: does not contain directory: \"a\"\na/e: does not contain directory: \"a\"\nb/d: does not contain directory: \"a\"\nb/a: does not contain directory: \"a\"", search.getOutput());
    assertEquals("search: \"x\": No such file or directory", search.getErrors());

    String[] tokens3 = {"search", "a", "b/a", "-type", "d", "-name", "\"s\""};
    search = new Search();
    search.run(tokens3, shell);
    assertEquals("a: does not contain directory: \"s\"\nb/a: does not contain directory: \"s\"", search.getOutput());
    assertEquals(null, search.getErrors());
  ...
  public final void testRun8() {
    ...
    search.run(tokens, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: a -name \"a\" -type d : Invalid combination of arguments", search.getErrors());

    String[] tokens2 = {"search", "hi", "type", "d", "name", "\"a\""};
    search = new Search();
    search.run(tokens2, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: hi type d name \"a\" : Invalid combination of arguments", search.getErrors());

    String[] tokens3 = {"search", "a", "b/a", "-", "f", "-S", "\"s\""};
    search = new Search();
    search.run(tokens3, shell);
    assertEquals(null, search.getOutput());
    assertEquals("search: a b/a - f -S \"s\" : Invalid combination of arguments", search.getErrors());
